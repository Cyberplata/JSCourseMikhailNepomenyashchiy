...
var _helpers = require("./src/helpers"); // По этому пути будут доступны все helpers
...
console.log("Hello from entry point", (0, _helpers.firstName));
console.log((0, _helpers.sum)(2, 4));
console.log((0, _helpers.addOne)(5)); // console.log(first.sum(2, 4));   // Как альтернатива записи выше
 // console.log(first.addOne(5));

},{"./src/helpers":"kEqbI"}],"kEqbI":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "sum", ()=>(0, _first.sum)) // Ещё один вариант синтаксиса. Реэкспорт - одновременно экспортирует и импрортирует две операции за раз, чтобы не писать длинный путь './src/helpers/first' => './src/helpers' 
;
parcelHelpers.export(exports, "addOne", ()=>(0, _first.addOne));
var _first = require("./first");
var _second = require("./second");
parcelHelpers.exportAll(_second, exports);
var _third = require("./third");
parcelHelpers.exportAll(_third, exports);

},{"./first":"g1fhg","./second":"cRqr4","./third":"aGKVo","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g1fhg":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{}],"cRqr4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "firstName", ()=>firstName);
const firstName = "John";

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"aGKVo":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "x", ()=>x);
parcelHelpers.export(exports, "default", ()=>print);
var _lodash = require("lodash"); // импорт без конкретного названия - './first', а просто 'lodash' и js автоматом находит, что это какая-то библиотека и находится в node_modules
...
},{}]},["3smKr","bB7Pu"], "bB7Pu", "parcelRequire0fce")
